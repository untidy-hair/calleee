# -*- coding: utf-8 -*-
#
# calleee documentation build configuration file, created by
...
version = re.search(r"\d+\.\d+", calleee.__version__).group()
# The full version, including alpha/beta/rc tags.
release = calleee.__version__
...
html_theme_options = {
    ...
    'description': calleee.__description__,

    'github_user': 'untidy-hair',
    'github_repo': 'calleee',
    'github_type': 'star',
    'github_count': False,
...
latex_documents = [
  (master_doc, 'calleee.tex', u'calleee Documentation',
...
man_pages = [
    (master_doc, 'calleee', u'calleee Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'calleee', u'calleee Documentation',
   author, 'calleee', 'One line description of project.',
   'Miscellaneous'),
]
...
autoclass_content_exceptions = [
    'calleee.operators.Contains',
    'calleee.operators.In',
]
...
def autodoc_process_docstring(app, what, name, obj, options, lines):
    ...
    """
    # check that only symbols that can be directly imported from ``calleee``
    # package are being documented
    _, symbol = name.rsplit('.', 1)
    if symbol not in calleee.__all__:
        raise SphinxError(
